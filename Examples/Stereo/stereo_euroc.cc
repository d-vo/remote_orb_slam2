...
int main(int argc, char **argv)
{
    ...
    std::vector<double> vTracking(nImages);
...
#endif
        double ttrackms= std::chrono::duration_cast<std::chrono::microseconds>(t2 - t1).count();
        std::cout << "Tracking time " << ttrackms / 1000.0 << std::endl;
